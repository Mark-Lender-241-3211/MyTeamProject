...
void MainWindow::displayRandomQuote() {
    ...
    ui->textBrowser->setHtml("<p align=\"center\">" + quotes[randomIndex] + "</p>");
}

void MainWindow::slot_help_show(QString login) {
    this->show();
}
...
void MainWindow::on_pushButton_exit_clicked() {
    ...
    CarCalculationsForm *calculationsForm = new CarCalculationsForm();
